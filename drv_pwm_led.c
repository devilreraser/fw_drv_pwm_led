...
{
    int set_high_point_timer_value = set_high_point_percent * pow(2, LEDC_DUTY_RES) / 100;
...
void drv_pwm_led_init(drv_pwm_led_e_channel_t e_channel, drv_pwm_led_e_pin_t e_pin, float set_high_point_percent)
{
    ...
    ESP_ERROR_CHECK(ledc_set_duty(LEDC_MODE, e_channel, duty));
